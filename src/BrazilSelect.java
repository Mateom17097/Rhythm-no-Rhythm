...
public class BrazilSelect{
	...
	public BrazilSelect() {
		...
		forward 	= getImage("/imgs/"+"BrazilSelect.png"); //load the image for Tree
	...
	public BrazilSelect(int x, int y) {
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = BrazilSelect.class.getResource(path);
