...
public class WeezerSelect{
	...
	public WeezerSelect() {
		...
		forward 	= getImage("/imgs/"+"WeezerSelect.png"); //load the image for Tree
	...
	public WeezerSelect(int x, int y) {
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = WeezerSelect.class.getResource(path);
