...
public class defaultArrow{
	...
	public defaultArrow() {
		forward 	= getImage("/imgs/"+"defaultArrow.png"); //load the image for Tree
	...
	public defaultArrow(int x, int y) {
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = defaultArrow.class.getResource(path);
