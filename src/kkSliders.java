...
public class kkSliders{
	...
	public kkSliders() {
		forward 	= getImage("/imgs/"+"kkSlider.png"); //load the image for Tree
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = kkSliders.class.getResource(path);
